...
class Student:
    def __init__(self,root):
        ...
        title = Label(self.root,text="Student Management System",bd=6,relief=GROOVE,font=("Algerian",30,'bold'),bg='Purple',fg='white' )
        ...
        #title = Label(self.root,text="Know me: Suraj Kumar/I am the one",bd=3,relief=GROOVE,font=("Brush Script MT",18),bg='Purple',fg='white' )
